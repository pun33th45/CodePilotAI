...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    // Brighter primary button for better contrast on dark backgrounds ("non-dark button")
    primary: "bg-brand-500 hover:bg-brand-400 text-white shadow-[0_0_20px_rgba(14,165,233,0.3)] hover:shadow-[0_0_25px_rgba(14,165,233,0.5)] border border-brand-400/20",
